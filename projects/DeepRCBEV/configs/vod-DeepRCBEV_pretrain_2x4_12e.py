# initialization
custom_imports = dict(imports=['projects.DeepRCBEV.mmdet3d_plugin'])
...
load_from = 'projects/DeepRCBEV/checkpoints/image_pretrained/mvx_faster_rcnn_detectron2-caffe_20e_coco-pretrain_gt-sample_kitti-3-class_moderate-79.3_20200207-a4a6a3c7.pth'
load_radar_from = 'projects/DeepRCBEV/checkpoints/vod-radarpillarnet_modified_4x1_80e/epoch_80.pth'
resume_from = None
workflow = [('train', 1)]